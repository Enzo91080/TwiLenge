...
// PAGE HISTORIQUE
// =============================================================
// Affiche toutes les sessions passees avec leurs defis et scores.
// =============================================================
...
export function History() {
  ...
  // Filtrer les sessions terminees
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-fortnite-muted mt-0.5">{ended.length} session(s) terminee(s)</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="card text-center py-12 border-dashed">
          ...
          <div className="text-white font-medium">Aucune session terminee</div>
...
function SessionRow({
  ...
  return (
    <div className="card">
      {/* En-tete de la session (cliquable pour expand) */}
      <button
          ...
          {challenges.map((sc) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                {sc.pointsEarned > 0 && (
                  <span className="text-fortnite-yellow text-sm font-medium">+{sc.pointsEarned} pts</span>
                )}
              </div>
            </div>
          ))}
